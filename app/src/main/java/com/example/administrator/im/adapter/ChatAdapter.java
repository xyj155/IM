...
public class ChatAdapter extends BaseMultiItemQuickAdapter<ChatEntity, BaseViewHolder> {
    ...
    public ChatAdapter(List<ChatEntity> data) {
        super(data);
        addItemType(ChatEntity.TYPE_SERVICES_MESSAGE, R.layout.main_recycle_item_chat_chatfriends);
        addItemType(ChatEntity.TYPE_CLIENT_MESSAGE, R.layout.main_recycle_item_chat_user);
    }
